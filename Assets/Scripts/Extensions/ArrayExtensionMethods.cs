...
{
    public static T[] AddToArray<T>(this T[] a, object o)
    {
    ...
    public static T[] AddToArrayAtIndex<T>(this T[] a, object o, int index)
    {
        if (index > a.Length)
        {
    ...
    public static T[] Remove<T>(this T[] a, object o)
    {
        if (a.GetType().GetElementType() == o.GetType())
        {
            if (a.Length == 0)
    ...
    public static T[] RemoveFromArrayAtIndex<T>(this T[] a, int index)
    {
        if (index >= a.Length)
        {
    ...
    public static T[] EfficientShuffle<T>(this T[] a)
    {
